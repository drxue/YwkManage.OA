	...
	// </auto-generated>
	//
	// <copyright file="DoctorRegisterBll.generated.cs">
	//  
	...
	{
		 public partial class DoctorRegisterService : BaseService<DoctorRegister>, IDoctorRegisterService
		{
			//使用spring.net的IOC注入方法，动态生成Dal实例。重载父类抽象方法（属性）
			public override IBaseDal<DoctorRegister> CurrentDal { get; set; }
		}
	}
